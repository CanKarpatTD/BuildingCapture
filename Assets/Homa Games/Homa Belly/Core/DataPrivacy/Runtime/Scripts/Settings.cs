...
#if UNITY_EDITOR
        public static Settings EditorCreateOrLoadDataPrivacySettings()
        {
            Settings asset = AssetDatabase.LoadAssetAtPath<Settings>(Constants.DATA_PRIVACY_SETTINGS_ASSET_PATH);
            if (asset == null)
            {
